...
import ru.fominmv.poms.libs.commons.collections.classes.ReferencedSyncList

import kotlin.properties.ReadWriteProperty
import kotlin.reflect.KProperty

class ReferencedSyncListDelegate<
    in HolderType,
    EffectiveHolderType,
...
>(
    ...
    private fun getInitializedProxy(holder: HolderType): ListType {
        if (proxy == null)
            proxy = convertList(
                ReferencedSyncList.doubleProxy(
    ...
    >(
        ...
        by ReferencedSyncCollectionDelegate.Reference(
            get = get,
            set = set,
